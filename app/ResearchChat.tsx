...
export function ResearchChat() {
  ...
  function CommitteeView() {
    return <>
      <WeatherStrip />
      <section className="command-guide" aria-label="How to read the command center"><div><p className="eyebrow">HOW TO READ THIS SCREEN</p><h2>Evidence becomes a controlled paper allocation</h2><span>Start with Fund Weather, review the CIO decision, inspect the probabilities and sources, then use the agent chat for questions.</span></div><ol><li><b>1</b><span><strong>Observe</strong>Live prices and market features</span></li><li><b>2</b><span><strong>Challenge</strong>Research and independent Risk review</span></li><li><b>3</b><span><strong>Decide</strong>CIO selects one of four gears</span></li><li><b>4</b><span><strong>Control</strong>Code applies limits and records the paper action</span></li></ol></section>
