...
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Description 'Runs the OH MEGA Pro paper investment committee at 08:00 Singapore time each Saturday.' -Force | Out-Null
